...
class TypesControllerTest < ActionController::TestCase
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post :create, type: { active: @type.active, name: @type.name, number: @type.number, sort: @type.sort, subtype: @type.subtype, year: @type.year }
    end
  ...
  test "should update type" do
    patch :update, id: @type, type: { active: @type.active, name: @type.name, number: @type.number, sort: @type.sort, subtype: @type.subtype, year: @type.year }
    assert_redirected_to type_path(assigns(:type))
  end
